...
const EditProductPage = () => {
  ...
  if (editProdMutation.isLoading) return <p>Loader...</p>; {/*(<Loader />)*/}

  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 ">
      <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[500px] w-[600px] rounded-md">
                  ...
                  <div className="flex items-center justify-center w-full">
                    {image === null ? (
                      ...
                      <div>
                        ...
                        <img
                          className="h-48 w-96"
                          src={filePreview || `http://localhost:8000${data.image}`}
